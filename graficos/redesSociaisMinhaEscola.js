...
async function redesSociaisFavoritasMinhaEscola() {
    ...
    if (dadosLocaisString) {
        ...
        const url = "https://script.google.com/macros/s/AKfycbycn_JoTQjloYCXNWI-xxpQBRtgK-1zC3oJaIsT6iOkAQZ5neTMxhBaZfPwdqVEBKUN/exec"
...
function processarDados(dados) {
    ...
    incluirTexto(`Como no mundo, a amostra de pessoas entrevistadas por mim, demonstra um apreço pelo <span>Tik Tok</span> em relação a outras redes.`)
}
